...
<div id="admin-layout" class="visible">
    ...
    <main id="admin-content">
        ...
        <div class="admin-page-sub">
            Progreso del jugador <strong style="color:var(--blue-bright);"><?= htmlspecialchars($usuario["username"]) ?></strong>
        </div>
        ...
        <form method="POST" action="../PHP/editar_progreso_action.php" class="admin-form">
