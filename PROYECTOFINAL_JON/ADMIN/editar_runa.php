    ...
    <main id="admin-content">
        ...
        <form method="POST" action="../PHP/mejoras_action.php" class="admin-form">
            ...
            <div class="admin-form-grupo">
                ...
                <input type="text" name="coste_base" class="admin-form-input input-abbr"
                       value="<?= $mejora["coste_base"] ?>" required>
            </div>
            ...
            <div class="admin-form-grupo">
                ...
                <input type="text" name="valor" class="admin-form-input input-abbr"
                       value="<?= $mejora["valor"] ?>" required>
            </div>
