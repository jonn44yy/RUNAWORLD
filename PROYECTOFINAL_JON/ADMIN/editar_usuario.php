...
$stmt = $conexion->prepare("
    SELECT u.id, u.username, u.email, u.genero,
...
<head>
    ...
    <title>RunaWorld — Editar Usuario</title>
...
<div id="admin-layout" class="visible">
    ...
    <main id="admin-content">
        ...
        <div class="admin-page-titulo">Editar Usuario</div>
        <div class="admin-page-sub">
            Modificando cuenta de <strong style="color:var(--blue-bright);"><?= htmlspecialchars($usuario["username"]) ?></strong>
        </div>
        ...
        <form method="POST" action="../PHP/editar_usuario_action.php" class="admin-form">
            <input type="hidden" name="id" value="<?= $usuario["id"] ?>">

            <div style="font-family:var(--font-title); font-size:0.7rem; letter-spacing:4px; text-transform:uppercase; color:var(--blue-bright); opacity:0.6; margin-bottom:-8px;">
                Datos de cuenta
            </div>
            ...
            <div class="admin-form-grupo">
                ...
                <input type="password" name="password" class="admin-form-input" placeholder="Nueva contrasena">
            </div>

            <div style="font-family:var(--font-title); font-size:0.7rem; letter-spacing:4px; text-transform:uppercase; color:var(--blue-bright); opacity:0.6; margin-bottom:-8px; margin-top:8px;">
                Progreso del jugador
            </div>

            <div class="admin-form-grupo">
                <label class="admin-form-label">Coins</label>
                <input type="number" step="0.01" name="coins" class="admin-form-input"
                       value="<?= $usuario["coins"] ?? 0 ?>">
            </div>

            <div class="admin-form-grupo">
                <label class="admin-form-label">Points</label>
                <input type="number" step="0.01" name="points" class="admin-form-input"
                       value="<?= $usuario["points"] ?? 0 ?>">
            </div>

            <div class="admin-form-grupo">
                <label class="admin-form-label">Coins por segundo</label>
                <input type="number" step="0.0001" name="coins_por_seg" class="admin-form-input"
                       value="<?= $usuario["coins_por_seg"] ?? 1 ?>">
            </div>
